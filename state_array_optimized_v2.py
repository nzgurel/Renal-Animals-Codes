...
result_folder_path = 'C:/Users/SmartBox/Desktop/Lab/Renal Results/Optimized_SA_10_12'
...
for animal in animal_names:
    ...
    for measure in measures:
        ...
        str_state_title = "StateArrayPlot_" + animal + "_" + measure_term + "_" + best_exc_thr + "_" + str(best_state_thr) + "(ci_width: " + str(min_width) + ")"
        ...
        if os.path.exists(stats_path):
            ...
            str_state_savefig_pdf = animal + "_PDF_" + measure_term + "_" + best_exc_thr + "_" + str(best_state_thr) + "_StateArray_fullexp.pdf"
